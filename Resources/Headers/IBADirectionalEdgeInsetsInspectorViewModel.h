...
@interface IBADirectionalEdgeInsetsInspectorViewModel : IBAInspectorViewModel
{
    NSNumber *_top;
    NSNumber *_leading;
    NSNumber *_bottom;
...
@property(readonly, nonatomic) NSNumber *trailingMax;
@property(readonly, nonatomic) NSNumber *trailingMin;
@property(readonly, nonatomic) NSNumber *bottomMax;
@property(readonly, nonatomic) NSNumber *bottomMin;
@property(readonly, nonatomic) NSNumber *leadingMax;
@property(readonly, nonatomic) NSNumber *leadingMin;
