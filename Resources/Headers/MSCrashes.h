...
@protocol MSChannelGroupProtocol, MSChannelUnitProtocol, MSCrashesDelegate, OS_dispatch_group, OS_dispatch_queue, OS_dispatch_semaphore;
...
@property(nonatomic) BOOL automaticProcessing; // @synthesize automaticProcessing=_automaticProcessing;
