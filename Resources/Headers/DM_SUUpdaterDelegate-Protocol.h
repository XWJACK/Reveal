...
@class DM_SUAppcast, DM_SUAppcastItem, DM_SUUpdater, NSAlert, NSArray, NSBundle, NSError, NSInvocation, NSMutableURLRequest, NSString;
@protocol DM_SUVersionComparison, DM_SUVersionDisplay;

@protocol DM_SUUpdaterDelegate <NSObject>

@optional
- (BOOL)updater:(DM_SUUpdater *)arg1 shouldGetInfoFromBundleItselfForBundle:(NSBundle *)arg2;
