...
@class IBAGCDAsyncReadPacket, IBAGCDAsyncSocketPreBuffer, IBAGCDAsyncWritePacket, NSData, NSMutableArray, NSString, NSURL;
@protocol OS_dispatch_queue, OS_dispatch_source;

@interface IBAGCDAsyncSocket : NSObject
{
    unsigned int flags;
    ...
    IBAGCDAsyncReadPacket *currentRead;
    IBAGCDAsyncWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    IBAGCDAsyncSocketPreBuffer *preBuffer;
    struct SSLContext *sslContext;
    IBAGCDAsyncSocketPreBuffer *sslPreBuffer;
...
- (BOOL)consumeConnectedSocketHandle:(int)arg1 withError:(id *)arg2;
...
- (BOOL)preConsumeConnectedSocketHandleWithError:(id *)arg1;
