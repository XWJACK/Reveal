...
@class NSCollectionView, _TtC6Reveal12CursorButton, _TtC6Reveal18DocumentController;
...
- (void)viewWillAppear;
- (void)viewDidLoad;
@property(nonatomic, readonly) _TtC6Reveal18DocumentController *documentController; // @synthesize documentController;
