...
+ (unsigned long long)versionInOpenedDatabase:(void *)arg1;
+ (BOOL)tableExists:(id)arg1 inOpenedDatabase:(void *)arg2;
+ (id)columnsIndexes:(struct NSDictionary *)arg1;
+ (unsigned long long)createTablesWithSchema:(struct NSDictionary *)arg1 inOpenedDatabase:(void *)arg2;
...
@property(readonly, nonatomic) NSURL *dbFileURL; // @synthesize dbFileURL=_dbFileURL;
- (void).cxx_destruct;
